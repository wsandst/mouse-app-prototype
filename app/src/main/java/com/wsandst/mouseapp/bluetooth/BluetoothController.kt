...
import com.wsandst.mouseapp.reports.FeatureReport


@Suppress("MemberVisibilityCanBePrivate")
public object BluetoothController: BluetoothHidDevice.Callback(), BluetoothProfile.ServiceListener {
    ...
    @JvmField var connectionComplete = false;
    var setReport = false;
    ...
    override fun onVirtualCableUnplug(device: BluetoothDevice?) {
        ...
        Log.d("BluetoothController", "onVirtualCableUnplug");
    }
